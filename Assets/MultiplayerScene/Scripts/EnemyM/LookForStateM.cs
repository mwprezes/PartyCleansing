...
public class LookForStateM : IEnemyAI
{
    ...
    public LookForStateM(EnemyStates enemy)
    {
        this.enemy = enemy;
    }
    ...
    public void OnTriggerEnter(Collider hit)
    {
        ...
        if (hit.gameObject.tag == "Pickable")
        {
            ...
            if (hit.tag != "Busted")
            {
                PlayerControllerM.Score = PlayerControllerM.Score - hit.GetComponent<GrabAndDrop>().Score_for_Item;
                hit.tag = "Busted";
            }
        }
        if (hit.gameObject.tag == "Player")
        {
            ...
            PlayerControllerM play = hit.gameObject.GetComponent<PlayerControllerM>();
            if (play.isHolding)
            {
